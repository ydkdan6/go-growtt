...
export default function AppHeader() {
  ...
  // Derive the best display name from available fields
    ...
    <header className="w-full bg-gradient-to-r from-[#001A1A] via-[#008080] to-[#001A1A] px-4 md:px-12 py-3 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#" className="text-white font-semibold text-sm hover:opacity-80 transition">Home</a>
          <a href="#" className="text-white text-opacity-60 text-sm hover:opacity-80 transition">Invest</a>
          <a href="#" className="text-white text-opacity-60 text-sm hover:opacity-80 transition">Learn</a>
          <a href="#" className="text-white text-opacity-60 text-sm hover:opacity-80 transition">Wallet</a>
        </nav>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex flex-col items-end justify-center">
          {isLoading ? (
            ...
            // Silent fail — don't break the header layout
            null
          ) : (
            <>
              {displayName && (
        ...
        {/* Notification Bell */}
        <button className="w-10 h-10 rounded-full bg-[#F0F5F5] flex items-center justify-center hover:opacity-80 transition flex-shrink-0">
        ...
        {isLoading ? (
          ...
          <InitialsAvatar name={displayName} email={displayEmail ?? undefined} />
        )}
